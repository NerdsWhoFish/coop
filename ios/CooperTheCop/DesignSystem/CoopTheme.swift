...
struct CoopBackground: ViewModifier {
  func body(content: Content) -> some View {
    content
      .foregroundStyle(CoopTheme.foreground)
      .tint(CoopTheme.cyan)
      .frame(maxWidth: .infinity, maxHeight: .infinity)
      .background(CoopTheme.background.ignoresSafeArea())
  }
}

extension View {
  func coopBackground() -> some View {
    modifier(CoopBackground())
  }
}
